...
<head>
    ...
    <title>Baby-home - Animation Utilities</title>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="Utilities-Temperature.jsp">Temperature</a>
                        <a class="collapse-item" href="Utilities-BPM.jsp">BPM</a>
                        <a class="collapse-item active" href="Utilities-animation.html">Animations</a>
                        <a class="collapse-item" href="Utilities-Surv.jsp">Surveillance</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Temperature</h1>
                    <p class="mb-4"></p>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card position-relative">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Show In Graph</h6>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
